...
test("voided historical statement payments do not block a replacement payment", () => {
  assert.deepEqual(paymentTotals([
    { transactionType: "EXPENSE", amount: 1_000, creditDebt: 1_000 },
    { transactionType: "STATEMENT_PAYMENT", amount: 1_000, creditDebt: -1_000, voidedAt: new Date("2026-08-20T00:00:00.000Z") },
  ]), { statementAmount: 1_000, paymentAmount: 0, outstandingAmount: 1_000 });
});
